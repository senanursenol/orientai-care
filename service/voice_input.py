"""Prepare browser-recorded speech as text input for a future AI model.

Current pipeline:

    audio bytes -> speech enhancement -> Whisper STT -> sentiment -> AI-ready text

Answer generation and TTS are intentionally not called yet. Once an AI model
is integrated, its text response can be passed to ``tts_service.synthesize``.
"""
...
from .sentiment import SentimentService, sentiment_service
...
class VoiceInputResult:
    """Text and metadata prepared for the future AI model."""
